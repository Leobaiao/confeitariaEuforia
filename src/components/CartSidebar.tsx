...
import { CartWhatsAppModal } from './CartWhatsAppModal';
...
export function CartSidebar() {
  ...
  // Abre o modal de WhatsApp e fecha o carrinho
  const handleCheckoutWhatsApp = () => {
    closeCart(); // Fecha o carrinho primeiro
    setWhatsAppModalOpen(true); // Depois abre o modal
  };

  // Callback chamado após sucesso do envio - fecha o carrinho
  ...
  const handleCheckoutIFood = () => {
    ...
    window.open(REDES_SOCIAIS.IFOOD, '_blank', 'noopener,noreferrer');

    toast.success('Redirecionando para iFood! 🍔', {
      description: 'Complete seu pedido no iFood'
    });
  ...
  return (
    <>
          ...
          <div className="flex flex-col flex-1 overflow-hidden px-4">
            {items.length === 0 ? (
              ...
              <>
                ...
                <div className="flex-shrink-0 border-t pt-4 pb-4 space-y-4 bg-white">
                  {/* Cupom de desconto */}
      ...
      {/* Modal de WhatsApp para checkout */}
      <CartWhatsAppModal
